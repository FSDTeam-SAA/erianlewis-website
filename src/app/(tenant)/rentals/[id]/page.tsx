...
const mockProperty = {
    ...
    leaseTerms: 'Month to month, 6 month, 12 month',
    utilitiesIncluded: "Yes", furnished: "Yes", petFriendly: "Yes",
    parkingType: 'Covered Parking', parkingSpace: 1,
    currencyType: 'JMD', pinConfirmed: "Yes",
    amenities: [
                    ...
                    <div className="flex-1 pb-16">
                        ...
                        <div className="flex items-center gap-3 mb-2">
                            <span className="text-[28px] font-extrabold text-gray-900 tracking-tight">
                                ...
                                <span className="text-[17px] font-medium text-gray-500">/mo</span>
                            </span>
                            <span
                        ...
                        <div className="mt-10">
                            <h2 className="text-[16px] font-bold text-gray-900 mb-5">Rental Details</h2>
