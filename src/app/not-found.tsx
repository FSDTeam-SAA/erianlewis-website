...
export default function NotFound() {
    ...
    return (
        <div className="relative flex min-h-screen w-full flex-col items-center justify-center overflow-hidden bg-gradient-to-br from-[#f0d5c8] via-[#d9e8f0] to-[#c8dff0] px-4 font-sans">
            ...
            {/* 🔵 Animated background bubbles matching the theme */}
            ...
            {/* 🌟 Main Content */}
            <div
                className={`z-10 flex flex-col items-center text-center transition-all duration-1000 ease-out bg-white/60 backdrop-blur-md p-10 md:p-16 rounded-[2rem] shadow-xl border border-white/50 ${isLoaded ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'
                    }`}
            >
            ...
            `,
                ...
                >
                    <h1 className="text-[6rem] sm:text-[8rem] md:text-[10rem] font-black leading-none tracking-tighter text-transparent bg-clip-text" style={{ backgroundImage: 'linear-gradient(90.99deg, #8BCCE6 2.49%, #F6855C 99.73%)' }}>
                        404
                    </h1>
                </div>
