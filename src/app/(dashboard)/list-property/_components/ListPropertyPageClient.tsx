...
export default function ListPropertyPageClient() {
    ...
    return (
      <main className="min-h-screen bg-[#F7F8FA]">
        <div className="border-b border-[#E5E7EB] bg-white">
          <div className="container mx-auto flex max-w-[1180px] items-center justify-between px-4 py-4 md:px-8">
            <Skeleton className="h-5 w-32 rounded-[8px]" />
            <Skeleton className="h-5 w-28 rounded-[8px]" />
          </div>
        </div>
        <div className="container mx-auto max-w-[1180px] space-y-6 px-4 py-8 md:px-8">
  ...
  if (categoriesQuery.isError || islandsQuery.isError) {
    return (
      <main className="min-h-screen bg-[#F7F8FA]">
        <div className="container mx-auto flex min-h-screen max-w-[1180px] items-center justify-center px-4 md:px-8">
  ...
  return (
    <main className="min-h-screen bg-[#F7F8FA]">
      <div className="container mx-auto max-w-[1180px] px-4 pb-8 pt-6 md:px-8">
