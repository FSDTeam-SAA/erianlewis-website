...
function DashboardSalesPageContent() {
  ...
  const [propertyToDelete, setPropertyToDelete] = useState<SalePropertyItem | null>(null)
          ...
          <div className="p-6">
            <DialogHeader className="text-left">
              ...
              <DialogDescription className="mt-2 text-sm leading-6 text-[#667085]">
                {propertyToDelete?.basicInformation?.propertyTitle || 'This property'} will be permanently removed from your sales listings.
              </DialogDescription>
            </DialogHeader>
          </div>
